...
class FeatureExtractor(nn.Module):
    ...
    using a pre-trained backbone network (ResNet50, EfficientNetV2-S) to extract 
    high-level visual features from leaf images.
    """
    def __init__(self, backbone='efficientnet_v2_s', pretrained=True, freeze_backbone=False):
        ...
        if backbone == 'resnet50':
            ...
            self.backbone = timm.create_model('efficientnet_v2_s', pretrained=pretrained, num_classes=0)
