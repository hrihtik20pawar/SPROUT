...
def plot_embeddings_tsne(embeddings, labels, prototypes=None, title="t-SNE Visualization of Embeddings", save_path=None):
    """
    ...
    Args:
        ...
        title: Plot title
        save_path: Path to save the plot as image (optional)
    """
    # Apply t-SNE
...
def plot_confusion_matrix(true_labels, pred_labels, title="Confusion Matrix", save_path=None):
    """
...
def plot_prototype_evolution(initial_prototypes, refined_prototypes, save_path=None):
    """
...
def plot_training_curves(train_accuracies, train_losses, save_path=None):
    """
...
def plot_shot_comparison(shot_results, save_path=None):
    """
...
def visualize_distance_heatmap(query_embeddings, prototypes, query_labels, save_path=None):
    """
